...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg">${config.logoText}</span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="/admin/profile/${user.id?c}" class="btn btn-default btn-flat">Profile</a>
                                </div>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <#if page.hierarchy??>
            <ol class="breadcrumb">
                <#list page.hierarchy as link>
                <li><a href="${link.url}"><i class="fa ${link.faIcon}"></i> ${link.text}</a></li>
                </#list>
